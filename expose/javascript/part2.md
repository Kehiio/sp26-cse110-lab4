...
4. This function will return the array object from the function containing all the discounted values, so containing `[50, 100, 150]`. This is because arrays are returnable objects in JavaScript
